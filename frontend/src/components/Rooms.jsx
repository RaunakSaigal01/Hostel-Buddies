...
export default function Rooms({ block }) {
  ...
  const getImageUrl = (blockLetter, key) => {
    const fileName = `${blockLetter}${key}.jpg`; // ex: A_AC2.jpg
    const found = images.find((img) => img.file_name === fileName);
    ...
    <section id="rooms" className="rooms" data-aos="fade-right">
      <div className="container">
        ...
        <div className="projects-grid">
          {Object.keys(roomTypes).map((key, i) =>
            block[key] > 0 ? (
  ...
  >
    <div className="flip-card-inner">
      <div className="flip-card-front">
        ...
        <br />
        <p className="pic">⁕⁕Click to See picture⁕⁕</p>
      </div>
